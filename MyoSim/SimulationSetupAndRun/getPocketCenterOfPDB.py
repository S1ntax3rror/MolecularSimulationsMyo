...
path_pdb = "/MyoSim/SimulationSetupAndRun/frozen_myo_strucutre_data/1K_withCO/dyna1.pdb"
...
def format_entry(index, group, atom_type, atom_name, x, y, z, mol_type, res_id, charge):
    return f"{index:>10}{group:>10}{atom_type:>4}{atom_name:>9}{x:>27.10f}{y:>20.10f}{z:>20.10f}{mol_type:>4}{res_id:>11}{charge:>20.10f}"
...
def exec_main(write_to_path, debug=False):
    ...
    print(entries[0])
    print("         2         1  CO        C              35.6210986328        7.7229528427       11.3982372284  CO       156        0.0000000000")
    output = "\n".join([header] + entries)
    if debug:
        print(output)
