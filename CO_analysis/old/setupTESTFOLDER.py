...
no_co_sim_folder_path = "Test_NO_CO"
with_co_sim_folder_path = "Test_WITH_CO"
...
for i, tag in enumerate(tags):
    ...
    for dyna_file_suffix in range(start_read, end_read):
        ...
        replace_line_in_file(path_step_4_inp, 82, "XREF " + str(center_XE5_XE4[0]) + " YREF " + str(center_XE5_XE4[1]) + " ZREF " + str(center_XE5_XE4[2]) + " -")
