...
template_file_path = "/WeirdMyoScan/ExecFileTemplate.sh"
input_file_path = "/WeirdMyoScan/input/input_orca_scan_0000"

input_file_path_prefix = "/WeirdMyoScan/input/input_orca_scan_"

input_file_path_prefix_on_beethoven = "/data/kaeserj/GaussianOpt/OrcaOpt/MyoScan/input/input_orca_scan_"
output_file_path_prefix_on_beethoven = "/data/kaeserj/GaussianOpt/OrcaOpt/MyoScan/output/output_orca_scan_"

exec_file_path_prefix = "/WeirdMyoScan/execfiles/exec_file_"
...
for i in range(num_files):
    ...
    input_file_path_beethoven = input_file_path_prefix_on_beethoven + str(i)
